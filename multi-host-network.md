...
vagrant@docker-node1:~$ nohup ./etcd --name docker-node1 --initial-advertise-peer-urls http://192.168.50.4:2380 \
...
--initial-cluster docker-node1=http://192.168.50.4:2380,docker-node2=http://192.168.50.5:2380 \
...
vagrant@docker-node2:~$ nohup ./etcd --name docker-node2 --initial-advertise-peer-urls http://192.168.50.5:2380 \
--listen-peer-urls http://192.168.50.5:2380 \
--listen-client-urls http://192.168.50.5:2379,http://127.0.0.1:2379 \
--advertise-client-urls http://192.168.50.5:2379 \
--initial-cluster-token etcd-cluster \
--initial-cluster docker-node1=http://192.168.50.4:2380,docker-node2=http://192.168.50.5:2380 \
--initial-cluster-state new&
```
